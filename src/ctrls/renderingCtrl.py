...
class RenderingCtrl(QObject):
    ...
    @Slot()
    def camChanged(self):
        self.__updateCameraPositionInBusinessModel()
    ...
    def __updateCameraPositionInBusinessModel(self):
        self.__hp.storeCamera(self.__businessModel.getCameraPosition())

    def __restoreCameraPosition(self, param):
        self.__hp.restoreCamera(self.__businessModel.getCameraPosition())
        self.__hp.render()
